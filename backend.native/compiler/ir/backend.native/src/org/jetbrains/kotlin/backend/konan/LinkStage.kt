...
//        targetTool("llc", optimizedBc, "-o", combinedS, *llcFlags, "-filetype=obj")
        targetTool("llvm-lto", *bitcodeFiles.toTypedArray(), "-o", combinedS, *optFlags, "-target-abi", "wasm32-unknown-unknown-wasm")
